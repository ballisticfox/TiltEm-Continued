...
harness: `dotnet run --project Docs/verification/TiltEmVerify.csproj -- --examples`.
...
All 28 defects are fixed. Verification lives in `Docs/verification/`, a standalone
...
Current result: **252 checks, 252 passed**.
