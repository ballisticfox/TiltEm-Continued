...
This rewrite uses a fixed anchor point captured by the body frame at the moment of entering the rotating reference frame, allowing for continuous entry/exit of the inverseRotating frame.
